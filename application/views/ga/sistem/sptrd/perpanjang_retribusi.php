						...
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<div class="table-toolbar">
									<div class="btn-group">
										<a  class="btn green" href="<?php echo base_url();?>ga/sptrd_perpanjangan_retribusi_excel" >
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										<tr >
											...
											<td>
											<a class="btn green" href="<?php echo base_url();?>ga/perpanjang_retribusi_edit/<?php echo $tampil['id_sptrd'];?>"><i class="icon-edit"></i> Perpanjang Retribusi</a>
