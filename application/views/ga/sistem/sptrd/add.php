					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>Add Data</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								...
								<div id="form_sample_2" class="form-horizontal">
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="nama_perusahaan" id="nama_perusahaan" class="span6 m-wrap" placeholder="Nama Perusahaan" />
										</div>
									</div>

									<div class="control-group">
										<label class="control-label">Nama Pemilik/ Penanggung Jawab</label>
										<div class="controls">
											<input type="text" name="nama_pemilik" id="nama_pemilik" class="span6 m-wrap" placeholder="Nama PemiliK/ Penanggung Jawab..." />
										</div>
									</div>
									<div class="control-group">
										<label class="control-label">Nomor IMB</label>
										<div class="controls">
											<input type="text" name="imb" id="imb" class="span6 m-wrap" placeholder="Nomor IMB..." />
										</div>
									</div>
									...
									<div class="control-group">
										...
										<div class="controls">
											<input type="text" name="tlp" id="tlp" class="span6 m-wrap" placeholder="Telephopne" />
										</div>
									</div>
									...
									<div class="control-group after-add-more">
												...
												<div class="controls">
													...
													<input type="text" name="jumlah" id="jumlah" class="span2 m-wrap" placeholder="Jumlah..." />
									...
									<div class="control-group">
										<label class="control-label">Luas Bangungan</label>
										<div class="controls">
											<input type="text" name="luas_bangunan" id="luas_bangunan" class="span6 m-wrap" placeholder="Luas Bangunan" />
										</div>
									</div>
