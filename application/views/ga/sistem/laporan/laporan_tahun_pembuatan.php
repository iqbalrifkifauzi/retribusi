					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>Cetak Laporan Kebutuhan Retribusi</div>
								<div class="tools">
							...
							<div class="portlet-body form">
								...
								<div class="form-horizontal">
									...
									<div class="control-group">
												<label class="control-label">Tahun pendataan <input type="checkbox" name="tahun" id="tahun" value="tahun"></label>
												<div class="controls">
