<div class="btn-group">
										<a  class="btn green" href="<?php echo base_url();?>ga/laporan_tahun_retribusi_sptrd_excel" >
...
<div class='alert alert-block alert-error show'>
		...
		<span>Data Retribusi Tahun = <?php echo date('Y');?>, Dengan Total Nominal = <?php echo rupiah($totalsemua);?></span>
</div>
