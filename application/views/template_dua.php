...
<head>
  <meta charset="utf-8" />
  <title>SISTEM INFORMASI RETRIBUSI DINAS PEMADAM KEBAKARAN KOTA BEKASI </title>
...
<body class="page-header-fixed">
  ...
  <div class="header navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="navbar-inner">
      <div class="container-fluid">
        ...
        <img src="<?php echo base_url();?>assets/img/disdamkar.png" alt="" /> 
        </a>
        <!-- END LOGO -->
        ...
        <ul class="nav pull-right">
          ...
          <li class="dropdown" id="header_inbox_bar">
            ...
            $bulan2=  date('m');
            $tahun = date('Y');
            $query = $this->db->query("select count(id_sptrd) as jml from tbl_sptrd where year(berlaku_sampai)='$tahun' and (month(berlaku_sampai)='$bulan2' or month(berlaku_sampai)='$bulan1' or month(berlaku_sampai)='$bulan') ");
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li class="external">
                <a href="<?php echo base_url();?>ga/ganti_tahun">Update Tahun <i class="m-icon-swapright"></i></a>
              </li>
            </ul>
          </li>
          ...
          <li class="dropdown" id="header_inbox_bar">
            ...
            $query2 = $this->db->query("select * from tbl_sptrd where month(berlaku_sampai)='$bulan2' or month(berlaku_sampai)='$bulan1' or month(berlaku_sampai)='$bulan' ");

            

            foreach ($query2->result_array() as $value) {
              
              $status = $value['status_perpanjang_retribusi'];
              $id     = $value['id_sptrd'];

              $query3 =  $this->db->query("select * from tbl_sptrd_perpanjangan_retribusi where year(bulan_pajak)='$tahun' and  month(bulan_pajak)='$bulan' and sptrd_id='$id' ");

              if($query3->num_rows()>0) {

              }
              else {
                $this->db->query("update tbl_sptrd set status_perpanjang_retribusi='1' where id_sptrd='$id' ");
            ...
            $query = $this->db->query("select count(id_sptrd) as jml from tbl_sptrd where status_perpanjang_retribusi='1' and (month(berlaku_sampai)='$bulan2' or month(berlaku_sampai)='$bulan1' or month(berlaku_sampai)='$bulan')  ");
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li class="external">
                <a href="<?php echo base_url();?>ga/perpanjang_retribusi">Perpanjang Retribusi<i class="m-icon-swapright"></i></a>
              </li>
            </ul>
          </li>
    ...
    <div class="page-sidebar nav-collapse collapse">
      ...
      <ul class="page-sidebar-menu">
        ...
        <li class="start active">
         ...
         <li>
          ...
          <ul class="sub-menu">
            ...
            <li>
              <a href="<?php echo base_url();?>ga/apk">
              APK
              </a>
            </li>
            <li>
              <a href="<?php echo base_url();?>ga/kecamatan">
              Kecamatan
              </a>
            </li>
          ...
          <li>
              <a href="<?php echo base_url();?>ga/sptrd">
              RETRIBUSI 
              </a>
            </li>
        </li>
       ...
       <!-- 
            ...
            <li>
              <a href="<?php echo base_url();?>ga/laporan_tahun_retribusi_sptrd">
              Monitoring Target Tahunan
              </a>
           
              <li>
              <a href="<?php echo base_url();?>ga/kmeans">
              K-Means
              </a>
  ...
  <script type="text/javascript" src="<?php echo base_url();?>assets/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.js"></script><script type="text/javascript" src="<?php echo base_url();?>assets/plugins/clockface/js/clockface.js"></script>
